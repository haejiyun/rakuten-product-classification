...
data_train = pd.read_csv('X_train_update_.csv',index_col=0)
...
data_test = pd.read_csv('X_test_update.csv',index_col=0)

st.write("La dimension de X_train:(84916, 4)")
st.write("La dimension de y_train:(84916, 1)")
...
st.image(Image.open("Picture0.png"), width =700)
...
data_train = pd.read_csv('X_train_rakuten_afterEDA_preprocessing_.csv')
...
exp6.image(Image.open("lemmatisation.png"))
...
exp7.image(Image.open("Picture1.png"))
exp7.text("")
exp7.write("- Très petites images : les stylos")
exp7.image(Image.open("Picture2.png"))
exp7.text("")
exp7.write("- Images incompréhensibles sans sa description textuelle")
exp7.image(Image.open("Picture3.png"))
exp7.image(Image.open("Picture4.png"))
...
st.write("La dimension des données:(84613, 6)")
